...
const HODDashboard = () => {
  ...
  const handleApprove = async (id) => {
    ...
    try {
      ...
      toast.success('Approved! Forward to Chief Proctor kar diya.');
                      ...
                      {!rejectingForms[id] && (
                        <div className="mt-4">
                          ...
                          <input
                            ...
                            value={remarks[id] || ''}
                            onChange={e => setRemarks(prev => ({ ...prev, [id]: e.target.value }))}
                            placeholder="Any notes for Chief Proctor..."
                      ...
                      <div className="mt-4 flex gap-3 flex-wrap">
                        ...
                        >
                          {isLoadingApprove ? (
                            ...
                            <><svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/></svg> Approve & Forward to Chief Proctor</>
                          )}
                        </button>
                        <button
